...
class This(Base):
    ...
    BINDINGS = [Binding(key, f"any( '{key}' )", "This") for key in ascii_lowercase]
...
class That(Base):
    ...
    BINDINGS = [Binding(key, f"any( '{key}' )", "That") for key in ascii_lowercase]
